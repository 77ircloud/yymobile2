...
When using `YyCarousel` in web projects, you may have problem about how to deal with variable item height.
...
````jsx
import { YyCarousel, WhiteSpace, WingBlank } from 'yymobile';
  ...
  render() {
    ...
    return (
      <WingBlank>
        ...
        <YyCarousel className="my-carousel"
          vertical
          dots={false}
          dragging={false}
          swiping={false}
          ...
          infinite
        >
          <div className="v-item">YyCarousel 1</div>
          <div className="v-item">YyCarousel 2</div>
          <div className="v-item">YyCarousel 3</div>
        </YyCarousel>
